...
{
    // 拆分http请求行
    char method[1024], path[1024], protocol[1024];
...
*/
    sprintf(buf, "<html><head><title>123: %s</title></head>", dirname);
    sprintf(buf+strlen(buf), "<body><h1>123: %s</h1><table>", dirname);
    char enstr[1024] = {0};
    char path[1024] = {0};
